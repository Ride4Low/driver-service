...
func (r *driverRepository) Create(ctx context.Context, driver *pb.Driver) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *driverRepository) GetByPackageSlug(ctx context.Context, packageSlug string) ([]string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
